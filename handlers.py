...
def send_m(_, message):
    email_sender.send_mail(email_sender.email, email_sender.password, email_sender.FROM, email_sender.TO, email_sender.msg)
    app.send_message('me', 'Success')
